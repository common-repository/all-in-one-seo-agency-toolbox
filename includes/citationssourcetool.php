        ...
        <div class="widget sat_widget">
            <div class="widget-top sat_nomovecursor">
                <div class="widget-title">                    
                    <h4><?php _e('Citations Source Tool', 'sat'); ?> <span class="in-widget-title"></span>
                        <a style="font-size: 12px;" class="sat_floatrigth sat_mariginleft" href="http://www.georanker.com/reports" target="_blank"><?php _e('Latest Reports', 'sat'); ?> </a>
                    </h4>
                </div>
            </div>
            <div class="widget-inside sat_nopadding" style="display: block;">
                ...
                $sat_subaction = 'citations';
                include 'formnewreport.php';                
                if ($sat_error) {
